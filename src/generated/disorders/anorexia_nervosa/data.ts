...
export const data = AnorexiaNervosaSchema.parse({
  ...
  rendering: {
    ...
    severity: {
      ...
      assignment_rule:
        "Baseado no IMC do adulto; criancas/adolescentes usar percentil do IMC por idade",
      domains: ["IMC"],
    },
  ...
  super_enrichment: {
    ...
    criterios_obrigatorios: [
      {
        ...
        texto:
          "Restricao da ingesta calorica em relacao as necessidades, levando a peso corporal significativamente baixo no contexto de idade, genero, trajetoria do desenvolvimento e saude fisica.\n- Peso significativamente baixo = inferior ao minimo normal (ou menor que o minimamente esperado em criancas/adolescentes)\n- Referencia: IMC < 17,0 kg/m² = magreza moderada/grave (OMS); IMC 17,0-18,5 = limiar\n- Criancas/adolescentes: IMC por idade abaixo do 5o percentil ou fracasso em manter trajetoria de crescimento",
      },
      {
        id: "B - Medo de ganhar peso",
        texto:
          "Medo intenso de ganhar peso ou engordar, OU comportamento persistente que interfere no ganho de peso, mesmo estando com peso significativamente baixo.\n- Nota: individuos mais jovens podem nao reconhecer medo; inferencia clinica permitida",
      },
      {
        id: "C - Dismorfia/perturbacao da imagem corporal",
        texto:
          "Perturbacao no modo como o proprio peso ou forma corporal sao vivenciados, influencia indevida do peso/forma na autoavaliacao, OU ausencia persistente de reconhecimento da gravidade do baixo peso.\n- Nota: a estima e altamente dependente da percepcao de peso/forma",
      },
    ],
    regra_diagnostica:
      "A = true(peso_significativamente_baixo) AND B = true(medo_ou_comportamento_interferente) AND C = true(dismorfia_ou_negacao_gravidade)",
    subtipos: [
      {
        Subtipo: "Tipo restritivo",
        Codigo: "F50.01",
        Regra:
          "Ultimos 3 meses: NENHUM episodio recorrente de compulsao + NENHUM comportamento purgativo",
      },
      {
        Subtipo: "Tipo compulsao alimentar purgativa",
        Codigo: "F50.02",
        Regra:
          "Ultimos 3 meses: episodios recorrentes de compulsao + purgacao (vomito autoinduzido, laxantes, diureticos, enemas)",
      },
    ],
    especificadores: ["Remissao parcial:", "Remissao completa:"],
    gravidade: {
      texto_completo:
    ...
    perguntas_chave_entrevista: [
      ...
      },
      {
        ...
        texto:
          "Como voce se ve? Acredita estar acima do peso mesmo outros dizendo que esta magro?",
      },
      {
        bloco: "Criterio C - Dismorfia:",
        texto:
          "O peso e a forma do corpo influenciam como voce se sente como pessoa?",
      },
      {
        bloco: "Criterio C - Dismorfia:",
        texto:
          "Voce reconhece que seu baixo peso pode ser perigoso para sua saude?",
      },
      {
        bloco: "Criterio C - Dismorfia:",
        texto:
          "Pesa com frequencia? Mede partes do corpo? Usa espelho excessivamente?",
      },
      {
        bloco: "Subtipo:",
        texto:
          "Nos ultimos 3 meses, teve episodios de comer em excesso com perda de controle?",
      },
      {
        bloco: "Subtipo:",
        texto:
          "Usa algum metodo para compensar a alimentacao? (vomito, laxantes, diureticos, exercicio excessivo)",
      },
    ],
    ui: {
      ...
      subtipo_obrigatorio: ["Restritivo", "Compulsão alimentar purgativa"],
      gravidade_por_imc: true,
      faixa_etaria: "Adolescência a adulto jovem",
      alerta_medico: "Condição potencialmente fatal",
    },
  },
  super_enrichment_source:
    "dsm/output/json_super_adicionado/anorexia_nervosa.json",
  enrichment_status: {
    has_poor: true,
    has_master: true,
    has_inventory: true,
