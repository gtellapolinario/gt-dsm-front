...
export const data = TranstornoAcumulacaoSchema.parse({
  ...
  "clusters_sintomas": [
    {
        "id": "A",
        "nome": "Dificuldade persistente de descartar pertences",
        ...
        "sintomas": [
            {
                ...
                "pergunta": "A pessoa tem muita dificuldade de se desfazer de objetos, mesmo quando não têm valor?",
    ...
    {
        "id": "B",
        "nome": "Necessidade de conservar e sofrimento ao descartar",
        "tipo": "monothetic_obrigatorio",
        "limiar": null,
        "ancora_obrigatoria": null,
        "sintomas": [
            {
                ...
                "pergunta": "A pessoa sente que precisa guardar as coisas e fica angustiado quando tenta se desfazer delas?",
                "faixa_aplicavel": null,
                "nota": null,
                "exemplos_clinicos": [
    ...
    {
        "id": "C",
        "nome": "Acúmulo que congestiona áreas de uso",
        "tipo": "monothetic_obrigatorio",
        "limiar": null,
        "ancora_obrigatoria": null,
        "sintomas": [
  ...
  "criterios_condicionais": [
    ...
    },
    {
        "id": "exclusao_outros",
        "letra": "E",
        "rotulo": "Não atribuível a outra condição médica",
        "tipo": "exclusao_substancia_medica",
        "ui_widget": "toggle_com_justificativa_obrigatoria",
        "obrigatorio": true,
        "icone": "Ban",
        "descricao_completa": "A acumulação não é atribuível a outra condição médica, como lesão cerebral, doença cerebrovascular ou síndrome de Prader-Willi.",
        "nota": null
    },
    {
        ...
        "ddx_sugeridos": [
            "esquizofrenia",
            "transtorno_neurocognitivo_maior"
        ],
        "descricao_completa": "A acumulação não é mais bem explicada por transtorno obsessivo-compulsivo, transtorno depressivo maior, esquizofrenia, transtorno do espectro autista ou transtorno neurocognitivo maior.",
        "nota": null
    }
],
  "subtipos": {
