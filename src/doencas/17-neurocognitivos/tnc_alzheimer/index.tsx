...
export default function TncAlzheimerAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Neurocognitivo Maior ou Leve Devido à Doença de Alzheimer"
      subtitulo="Transtorno Neurocognitivo Maior ou Leve Devido à Doença de Alzheimer (294.1x / F02.8x)"
