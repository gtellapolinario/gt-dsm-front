...
export default function TncVascularAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Neurocognitivo Vascular Maior ou Leve"
      subtitulo="Transtorno Neurocognitivo Vascular Maior ou Leve (290.40 / F01.5x)"
