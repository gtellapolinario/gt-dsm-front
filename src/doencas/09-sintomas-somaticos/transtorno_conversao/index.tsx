...
import { useMonotheticPureEvaluation } from "@/hooks/evaluation-hooks";
...
export default function TranstornoConversaoAvaliacao() {
  const hook = useMonotheticPureEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="Transtorno de Conversão (Transtorno de Sintomas Neurológicos Funcionais)"
      subtitulo="Transtorno de Conversão (Transtorno de Sintomas Neurológicos Funcionais) (300.11 / F44.x)"
