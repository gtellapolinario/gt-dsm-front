...
import { useTripartiteFunctionalEvaluation } from "@/hooks/evaluation-hooks";
...
export default function DIAvaliacao() {
  const hook = useTripartiteFunctionalEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="DI"
      subtitulo="Transtorno do Desenvolvimento Intelectual (Deficiência Intelectual) (319 / F79)"
