...
export default function TranstornoEspecificoAprendizagemAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Específico da Aprendizagem"
      subtitulo="Transtorno Específico da Aprendizagem (315.00 / F81.0)"
