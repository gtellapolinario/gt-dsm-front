...
export default function TranstornoEscoriacaoAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Transtorno de Escoriação (Skin-Picking)"
      subtitulo="Transtorno de Escoriação (Skin-Picking) (698.4 / L98.1)"
