...
export default function TricotilomaniaAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Tricotilomania (Transtorno de Arrancar o Cabelo)"
      subtitulo="Tricotilomania (Transtorno de Arrancar o Cabelo) (312.39 / F63.3)"
