...
const rawData = {
  ...
  "id": "transtorno_depressivo_persistente",
  "item_id": "transtorno_depressivo_persistente",
  ...
  "raw_document": {
    ...
    "raw_document": {
      ...
      "rendering": {
        ...
        "severity": {
          "has_formal_severity": true,
          "type": "ordinal_simples",
          "levels": [
            "leve",
            "moderado",
            "grave"
          ],
          "assignment_rule": "Mesma escala do TDM",
          "domains": []
        },
      ...
      "super_enrichment": {
        "id": "transtorno_depressivo_persistente",
        "nome_original": "TRANSTORNO DEPRESSIVO PERSISTENTE",
        "comorbidades_frequentes": [
          {
            "condicao": "Transtornos de ansiedade",
            "frequencia": "alta",
        ...
        "instrumentos_complementares": [],
        "transtorno_depressivo_persistente": "| Campo | Valor |\n|-------|-------|\n| **nome** | Transtorno Depressivo Persistente (Distimia) |\n| **categoria_operacional** | FULL |\n| **codigo_dsm5** | 300.4 (F34.1) |\n| **codigo_cid10** | F34.1 |\n| **estrutura_diagnostica** | polythetic_monocluster |",
        "criterios_obrigatorios": [
          {
            "id": "A - Humor deprimido",
            "texto": "Humor deprimido na maior parte do dia, na maioria dos dias, indicado por relato subjetivo ou observação, por período mínimo de **2 anos** (1 ano para crianças/adolescentes).\n> Nota: Em crianças/adolescentes, humor pode ser irritável; duração mínima 1 ano."
          },
          {
            "id": "B - Sintomas associados",
            "texto": "Presença, enquanto deprimido, de **2 (ou mais)** das seguintes características:\n1. Apetite diminuído ou alimentação em excesso\n2. Insônia ou hipersonia\n3. Baixa energia ou fadiga\n4. Baixa autoestima\n5. Concentração pobre ou dificuldade em tomar decisões\n6. Sentimentos de desesperança"
          },
          {
            "id": "C - Continuidade",
            "texto": "Durante 2 anos (1 ano crianças), jamais esteve sem sintomas dos Critérios A e B por mais de **2 meses consecutivos**."
          },
          {
            "id": "D - Possível presença de TDM",
            "texto": "Critérios para TDM podem estar continuamente presentes por 2 anos."
          },
          {
            "id": "E - Exclusão bipolar/ciclotímia",
            "texto": "Jamais houve episódio maníaco ou hipomaníaco; jamais foram satisfeitos critérios para ciclotímia."
          },
          {
            "id": "F - Exclusão psicose",
            "texto": "Não explicado por esquizoafetivo persistente, esquizofrenia, delirante ou outro transtorno psicótico."
          },
          {
            "id": "G - Exclusão substância/condição médica",
            "texto": "Sintomas não se devem a efeitos fisiológicos de substância ou condição médica (ex: hipotireoidismo)."
          },
          {
            "id": "H - Prejuízo/sofrimento",
            "texto": "Sintomas causam sofrimento clinicamente significativo ou prejuízo no funcionamento."
          }
        ],
        "regra_diagnostica": "- A (humor deprimido ≥2 anos) + B (≥2 de 6 sintomas) + C (sem remissão >2 meses) + D-H (exclusões)",
        "especificadores": [
          {
            "Especificador": "Com sintomas ansiosos",
            "Critério": "Mesmo critério do TDM"
          },
          {
          ...
          },
          {
            ...
            "Critério": "Congruentes ou incongruentes"
          },
          "Início precoce:",
          "Início tardio:"
        ],
        "especificadores_curso": [
          {
            ...
            "Definição": "NUNCA foram satisfeitos critérios para EDM nos últimos 2 anos"
          },
          {
            "Especificador": "Com episódio depressivo maior persistente",
            "Definição": "Critérios para EDM satisfeitos durante TODO o período de 2 anos"
          },
          {
            "Especificador": "Com episódios depressivos maiores intermitentes, com episódio atual",
            "Definição": "EDM atualmente presente; períodos ≥8 semanas abaixo do limiar nos últimos 2 anos"
          },
          {
            "Especificador": "Com episódios depressivos maiores intermitentes, sem episódio atual",
            "Definição": "EDM não atual; 1+ episódios EDM nos últimos 2 anos"
          }
        ],
        "gravidade": {
        ...
        "diferenciais_criticos": [
          {
            "Condição": "TDM (episódio único)",
            "Distinção": "Duração do EDM ≥2 semanas mas <2 anos; sintomas mais graves"
          },
          {
            "Condição": "TDM crônico",
            "Distinção": "Satisfaz critérios de EDM continuamente por ≥2 anos → codificar como distimia com especificador"
          },
          {
            "Condição": "Transtorno bipolar",
            "Distinção": "Excluir história de mania/hipomania"
          },
          {
            "Condição": "Transtorno depressivo por substância/condição médica",
            "Distinção": "Etiologia atribuível"
          },
          {
            "Condição": "Transtornos da personalidade",
            "Distinção": "Podem coexistir; avaliar se humor deprimido é independente"
          }
        ],
        "perguntas_chave": "1. \"Você se sente deprimido ou desanimado na maior parte do tempo há quanto tempo?\" (Critério A)\n2. \"Nesse período, houve algum intervalo de mais de 2 meses sem se sentir assim?\" (Critério C)\n3. \"Nos últimos 2 anos, houve períodos em que os sintomas foram muito piores?\" (especificador de EDM)\n4. \"Já teve algum período de humor anormalmente elevado?\" (Critério E - bipolar)\n5. \"Como isso afeta seu funcionamento diário?\" (Critério H)",
        "ui": {
          "renderiza_entrevista": true,
          "modo": "structured_full",
          "observacoes": "- Pacientes com início precoce podem não perceber que o humor deprimido é anormal (\"sempre fui assim\")"
        }
      },
      "super_enrichment_source": "dsm/output/json_super_adicionado/transtorno_depressivo_persistente.json",
      "enrichment_status": {
        "has_poor": true,
        "has_master": true,
        "has_inventory": true,
