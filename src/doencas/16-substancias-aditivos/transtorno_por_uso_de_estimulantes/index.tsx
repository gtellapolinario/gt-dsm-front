...
export default function TranstornoPorUsoDeEstimulantesAvaliacao() {
  ...
  return (
    <ConsultaShell
      titulo="Transtorno por Uso de Estimulantes"
      subtitulo="Transtorno por Uso de Estimulantes (304.40 / F15.20)"
