...
import { useCategoricoSubtipoEvaluation } from "@/hooks/evaluation-hooks";
...
export default function TranstornoDeliranteAvaliacao() {
  const hook = useCategoricoSubtipoEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Delirante"
      subtitulo="Transtorno Delirante (297.1 / F22)"
