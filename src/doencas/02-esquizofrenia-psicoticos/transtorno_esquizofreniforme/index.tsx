...
import { usePolytheticAncoraEvaluation } from "@/hooks/evaluation-hooks";
...
export default function TranstornoEsquizofreniformeAvaliacao() {
  const hook = usePolytheticAncoraEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Esquizofreniforme"
      subtitulo="Transtorno Esquizofreniforme (295.40 / F20.81)"
