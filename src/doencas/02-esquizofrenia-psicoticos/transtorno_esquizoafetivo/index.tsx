...
import { useConjuncaoTemporalEvaluation } from "@/hooks/evaluation-hooks";
...
export default function TranstornoEsquizoafetivoAvaliacao() {
  const hook = useConjuncaoTemporalEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="Transtorno Esquizoafetivo"
      subtitulo="Transtorno Esquizoafetivo (295.70 / F25.9)"
