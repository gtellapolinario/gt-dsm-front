...
import { useEtiologicoExternoEvaluation } from "@/hooks/evaluation-hooks";
...
export default function TranstornosAdaptacaoAvaliacao() {
  const hook = useEtiologicoExternoEvaluation(data);
  const {
    identificacao,
    formValues,
    payload,
  ...
  return (
    <ConsultaShell
      titulo="Transtornos de Adaptação"
      subtitulo="Transtornos de Adaptação (309.0 / F43.20)"
