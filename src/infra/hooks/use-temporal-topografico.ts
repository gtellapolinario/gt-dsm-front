/**
 * ============================================================
 * Hook 2: useTemporalTopografico
 * ============================================================
 * Transtornos com criterios temporais/topograficos.
 * Sem clusters formais — usa criterios baseados em duracao,
 * frequencia e localizacao.
 *
 * Exemplo: Transtorno de Tourette, Tiques.
...
/* ------------------------------------------------------------
 * Estado interno — sem clusters, com criterios temporais
 * ------------------------------------------------------------ */

interface TemporalFormState {
...
const FORM_INICIAL: TemporalFormState = {
...
export interface TemporalTopograficoReturn {
  /** Dados de identificacao do paciente */
  identificacao: IdentificacaoState;
  /** Valores do formulario interno */
  formValues: TemporalFormState;
  /** Contagem de criterios temporais atendidos */
...
/* ------------------------------------------------------------
 * Adapter: TemporalFormState -> FormValues
 * ------------------------------------------------------------ */

function adaptToFormValues(form: TemporalFormState): FormValues {
  return {
    clusters: {},
