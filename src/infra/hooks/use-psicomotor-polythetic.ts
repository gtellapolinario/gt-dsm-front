/**
 * ============================================================
 * Hook 6: usePsicomotorPolythetic
 * ============================================================
 * Clusters psicomotores — similar a polythetic mas com sintomas motores.
 * Avalia sintomas motores, verbais e vocalicos em clusters separados.
 *
...
/* ------------------------------------------------------------
 * Estado interno — clusters psicomotores
 * ------------------------------------------------------------ */

interface PsicomotorFormState {
...
const FORM_INICIAL: PsicomotorFormState = {
  clusters: {},
...
/* ------------------------------------------------------------
 * Adapter: PsicomotorFormState -> FormValues
 * ------------------------------------------------------------ */

function adaptToFormValues(form: PsicomotorFormState): FormValues {
  return {
...
export function usePsicomotorPolythetic(
  data: TranstornoDSM,
): PsicomotorPolytheticReturn {
  const [identificacao, setIdentificacao] = useState<IdentificacaoState>(
    IDENTIFICACAO_INICIAL,
  );
  const [formValues, setFormValues] = useState<PsicomotorFormState>(FORM_INICIAL);
