...
function useBaseEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  ...
  const toggleSintoma = useCallback((clusterId: string, sintomaId: string, checked: boolean) => {
    setFormValues((prev) => {
  ...
  const setNotasClinicas = useCallback((campo: string, valor: string, subcampo?: string) => {
    setFormValues((prev) => {
  ...
  const contadores = useMemo(() => {
    ...
    clusters.forEach((cl) => {
      ...
      const selected = symptoms.filter((s) => clusterState[s.id]?.checked).length;
...
${(data.clusters_sintomas || []).map((cl) => {
  const stats = contadores[cl.id] || { selecionados: 0, total: cl.sintomas.length };
...
export function usePolytheticClusterEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function usePolytheticMonoClusterEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function usePolytheticAncoraEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useMonotheticPureEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useMonotheticTripartiteEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}
...
export function useTemporalTopograficEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useEtiologicoExternoEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useQualitativoDescritivoEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useEpisodicEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useTripartiteFunctionalEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useConjuncaoTemporalEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useCategoricoSubtipoEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function usePsicomotorPolytheticEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}

export function useDefaultEvaluation(data: TranstornoDSM): DiseaseEvaluationHook {
  return useBaseEvaluation(data);
}
